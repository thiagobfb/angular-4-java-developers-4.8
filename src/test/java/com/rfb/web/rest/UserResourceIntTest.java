...
public class UserResourceIntTest {
    ...
    public void createUser() throws Exception {
        ...
        managedUserVM.setAuthorities(Collections.singleton(AuthoritiesConstants.RUNNER));
    ...
    public void getAllAuthorities() throws Exception {
        restUserMockMvc.perform(get("/api/users/authorities")
            ...
            .andExpect(jsonPath("$").value(containsInAnyOrder(AuthoritiesConstants.RUNNER, AuthoritiesConstants.ADMIN, AuthoritiesConstants.ORGANIZER)));
    }
