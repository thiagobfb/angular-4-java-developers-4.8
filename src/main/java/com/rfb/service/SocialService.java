...
public class SocialService {
    ...
    private void init() {
        try {
            String[] fieldsToMap = {
                ...
                "quotes", "payment_pricepoints", "relationship_status", "religion", "security_settings", "significant_other",
    ...
    private User createUserIfNotExist(UserProfile userProfile, String langKey, String providerId, String imageUrl) {
        ...
        if (StringUtils.isBlank(email) && userRepository.findOneByLogin(getFormattedLogin(userName)).isPresent()) {
    ...
    private String getFormattedLogin(String fbLogin) {
        return fbLogin.replace(" ", "_");
    }
