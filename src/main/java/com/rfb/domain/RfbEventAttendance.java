...
public class RfbEventAttendance implements Serializable {
    ...
    public LocalDate getAttedanceDate() {
        return attedanceDate;
    }

    public RfbEventAttendance attedanceDate(LocalDate attedanceDate) {
        this.attedanceDate = attedanceDate;
        return this;
    }

    public void setAttedanceDate(LocalDate attedanceDate) {
        this.attedanceDate = attedanceDate;
    }
